...
<<<<<<< HEAD:api/core/v1alpha1/zz_generated.deepcopy.go
	return
=======
...
>>>>>>> 4aa9d7fe (make generate):api/v1alpha1/zz_generated.deepcopy.go
}
...
func (in *ExistingCluster) DeepCopyInto(out *ExistingCluster) {
	*out = *in
	if in.MemberURLs != nil {
		in, out := &in.MemberURLs, &out.MemberURLs
		*out = make(map[string][]string, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
