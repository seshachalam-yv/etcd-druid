...
var (
	...
	//go:embed druid.gardener.cloud_etcdmembers.yaml
	etcdMemberCRD string
)
...
const (
	...
	// ResourceNameEtcdMember is the name of the EtcdMember CRD.
	ResourceNameEtcdMember = "etcdmembers.druid.gardener.cloud"
)
